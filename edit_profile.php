...
if(isset($_POST["submit"])) {
    ...
    // $sql = "INSERT INTO `user_selection`(`candidateID`, `current_school`, `first_choice`, `second_choice`, `third_choice`, `fourth_choice`) VALUES ('$id','$current_inst','$first_choice','$second_choice','$third_choice','$fourth_choice')";
